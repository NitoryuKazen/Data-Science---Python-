...
########
	...
	if os.path.isfile('ajust-bcg-exp-2.fits'):
		ajust1 = pyfits.getdata('ajust-bcg-exp-2.fits',1)
		ajust3 = pyfits.getdata('ajust-bcg-exp-2.fits',3)
		mask = pyfits.getdata('bcg_r_mask.fits')
		mask_b = pyfits.getdata('bcg_r_mask_b.fits')
		header = pyfits.getheader('ajust-bcg-exp-2.fits',2)
	##############################################################
...
# inicio do sigma.fits:
		...
		mask1 = pyfits.getdata(cluster+'/bcg_r_mask.fits')
		mask2 = pyfits.getdata(cluster+'/bcg_r_mask_b.fits')
		
		mask = copy.deepcopy(mask1[ninfy:nsupy,ninfx:nsupx])
		mask_b = copy.deepcopy(mask2[ninfy:nsupy,ninfx:nsupx])
		print len(mask)
